...
bool isAllLow(void) {
    if ((CTRTstate[0][0] == LOW) && (CTRTstate[1][0] == LOW) && (CTRTstate[2][0] == LOW) && (CTRTstate[3][0] == LOW) && (CTRTstate[4][0] == LOW) && (CTRTstate[5][0] == LOW) && (CTRTstate[6][0] == LOW)) {
        return 1;
    } else {
        return 0;
    }
...
bool isAllHigh(void) {
    if ((CTRTstate[0][0] == HIGH) && (CTRTstate[1][0] == HIGH) && (CTRTstate[2][0] == HIGH) && (CTRTstate[3][0] == HIGH) && (CTRTstate[4][0] == HIGH) && (CTRTstate[5][0] == HIGH) && (CTRTstate[6][0] == HIGH)) {
        return 1;
    } else {
        return 0;
    }
